<?php include "templates/include/header.php" ?>
	...
	<div id="MainTitle">
        <h1 class="mainTitle">Regular Menu</h1>
	</div>
	<div id="div-07">
	...
	<div id="ErrorStatusMessage">
        <?php if ( isset( $results['errorMesage'] ) ) { ?>
	...
	<div id="Signout">
        <p class="signoutLine">Your are logged in as <b><?php echo htmlspecialchars( $_SESSION['username']) ?></b>. <a href="index.php?action=logout" class="Links"?> .:LOG OUT:.</a></p>
	</div>
	<div id="div-13">
	...
	<div id="AddDeleteButtons">
        <p><a  class="Links" href="index.php?action=addRegularMenuItem">ADD NEW ITEM</a></p>
	</div>
	<div id="div-20">
	...
	<div id="MainContent">
        <table>
            ...
            <?php foreach ( $results['regularMenuItems'] as $regularMenuItem) { ?>
            <tr onclick="location='index.php?action=editRegularMenuItem&amp;regularMenuItemId=<?php echo $regularMenuItem->id?>'">
                <td>
                    <?php echo $regularMenuItem->name?>
                </td>
                <td>
                    <?php echo $regularMenuItem->price?>
                </td>
                <td>
                    <?php echo $regularMenuItem->type?>
                </td>
                <td>
                    <?php echo $regularMenuItem->description?>
                </td>
            </tr>
            <?php } ?>
        </table>

        <p><?php echo $results['totalRows']?> items<?php echo ( $results['totalRows'] != 1 ) ? 's' : ''?> in total.</p>

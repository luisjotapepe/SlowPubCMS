<?php include "templates/include/header.php" ?>
	...
	<div id="AddDeleteButtons" class="fontStyle">
        <p><a  class="Links" href="index.php?action=addEventItem">ADD NEW ITEM</a></p>
	</div>
	<div id="div-20">
	...
	<div id="MainContent" class="fontStyle">
        <table>
            ...
            <?php foreach ( $results['newResults'] as $eventItem) { ?>
            <tr onclick="location='index.php?action=editEventItem&amp;eventItemId=<?php echo $eventItem->id?>'">
                <td>
                    <?php echo $eventItem->name?>
                </td>
                <td>
                    <?php
                        if(strlen($eventItem->description)<17) echo $eventItem->description;
                        else echo substr($eventItem->description, 0, 17).'...';
                    ?>
                </td>
                <td>
                    <?php echo $eventItem->date?>
                </td>
            </tr>
            <?php } ?>
        </table>

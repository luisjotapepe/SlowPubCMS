<?php include "templates/include/header.php" ?>
	...
	<div id="usernameField">
        ...
        <input type="text" name="username" id="username" class="loginInput" placeholder="Your admin username" required autofocus maxlength="20" />
	</div>
	<div id="login-div-08">
	...
	<div id="passwordField">
        <input type="password" name="password" id="password" class="loginInput" placeholder="Your admin password" required maxlength="20" />
	</div>
	<div id="login-div-11">
	...
	<div id="loginButton" >
        <input type="submit" name="login" value="" class="loginButton" />
	</div>
	<div id="login-div-14">

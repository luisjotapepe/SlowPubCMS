<?php include "templates/include/header.php" ?>
	...
	<div id="AddDeleteButtons" class="fontStyle">
        <p><a  class="Links" href="index.php?action=addDailyMenuItem">ADD NEW ITEM</a></p>
	</div>
	<div id="div-20">
	...
	<div id="MainContent" class="fontStyle">
        ...
        <?php foreach ( $results['dailyMenuItems'] as $dailyMenuItem) { ?>
        <tr onclick="location='index.php?action=editDailyMenuItem&dailyMenuItemId=<?php echo $dailyMenuItem->id?>'">
            <td>
                <?php echo $dailyMenuItem->name?>
            </td>
            <td>
                <?php echo $dailyMenuItem->description?>
            </td>
            <td class="price">
                <?php echo $dailyMenuItem->price?>
            </td>
        </tr>
        <?php } ?>
        </table>

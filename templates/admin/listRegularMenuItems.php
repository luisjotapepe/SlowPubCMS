<?php include "templates/include/header.php" ?>
	...
	<div id="MainContent" class="fontStyle">
        <table>
            ...
            <?php foreach ( $results['newResults'] as $regularMenuItem) { ?>
            <tr onclick="location='index.php?action=editRegularMenuItem&amp;regularMenuItemId=<?php echo $regularMenuItem->id?>'">
                <td>
                    <?php
                    if(strlen($regularMenuItem->name)<20) echo $regularMenuItem->name;
                    else echo substr($regularMenuItem->name, 0, 20).'...';
                    ?>
                </td>
                <td>
                    <?php
                    if(strlen($regularMenuItem->description)<30) echo $regularMenuItem->description;
                    else echo substr($regularMenuItem->description, 0, 30).'...';
                    ?>
                </td>
                <td>
